...
struct CircleLoader: View {
    ...
    let circleTrackGradient = LinearGradient(colors: [Color(.blue),Color(.green)], startPoint: .leading, endPoint: .bottomLeading)
    let circleRoundGradient = LinearGradient(gradient: .init(colors: [Color.cyan, Color.mint]), startPoint: .topLeading, endPoint: .trailing)
